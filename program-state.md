...
Generated June 9, 2026. Single-file bundle of all 15 program documents plus verification scripts.
...
16. verify_dls.py (appendix A)
17. wp21_test.py (appendix B)
18. empirics_d.py (appendix C)
19. e1_probe.py (appendix D)
20. e2_probe.py (appendix E)
21. fine_class_probe.py (appendix F)
