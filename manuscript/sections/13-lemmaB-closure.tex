...
This section supplies every supporting lemma Lemma~\ref{lem:B} needs in
order to follow from \cite{TT25}, Theorem~3.1 (statement verified
against the v2 source; ledger items B1--B3). After it, Lemma~B's only
remaining debt is the final assembly bookkeeping of
